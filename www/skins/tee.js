function render(skin)
{
	...
	ctx.drawImage(skin,192,64,64,32,8,32,64,32); //back feet shadow
	...
	ctx.drawImage(skin,192,64,64,32,24,32,64,32); //front feet shadow
...
document.body.onload=function(){
	table = document.querySelectorAll(".nowraptable")[0];
	images = table.querySelectorAll("img");
