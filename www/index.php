...
<div class="startvideo"><div class="video-container"><iframe allowfullscreen class="ytplayer" src="http://www.youtube.com/embed/ydaHs3CAcAg?autoplay=0&hd=1"></iframe></div><div align="right">More videos in the <a href="/halloffame/">Hall of Fame</a></div></div>
...
<ul>
  ...
  <ul>
    ...
    <li>[Mapping] Automapper rules for generic_unhookable (+0.7) (by hi_leute_gll)</li>
    <li>[Server] Support for JS clients (by eeeee)</li>
  </ul></li>
  <li><a href="http://forum.ddnet.tw/viewtopic.php?f=14&t=1033">The Great Mapping Guide</a> by Index</li>
  <li><strong>DDNet 7.0</strong>:<br/>
  <ul>
    <li><strong>[Client] Faster map download using HTTP for DDNet maps (by Learath2)</strong></li>
    <li>[Client] Fix highlighting color in F1</li>
    <li>[Server] Fix: Make /map work with #</li>
  </ul></li>
  ...
  <ul>
    <li>[Client] Antiping: prediction of weak/strong hook (by trml)</li>
    <li>[Mapping] New tile: Refill jumps (by DoNe)</li>
    <li>[Mapping] Fix water mapres (by Soreu, found by hi_leute_gll)</li>
  </ul></li>
  <li><strong>DDNet 6.6.7</strong>:<br/>
  <ul>
    <li>[Client] Fix: No jetpack prediction on DDNet incompatible servers</li>
    <li>[Client] Add default zoom setting</li>
    <li>[Mapping] Add hook duration tune</li>
    <li>[Server] Various fixes</li>
  </ul></li>
  <li><strong>InfectionZ &amp; BlockZ Servers with DDNet features!</strong>:<br/>
  <p>
    Thanks to coffee we're now running DDNet InfectionZ &amp; BlockZ servers everywhere!
    Many DDNet features and 64 players! Have fun fighting with zombies!
  </p></li>
