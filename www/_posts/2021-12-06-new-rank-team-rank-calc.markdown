...
Inbetween (x between 0 and 1): Exponential decay: points(x) = floor(100 * e ^ (-λ * ratio(x)))
  ratio(x) = (x - top) / (median - top)
  Calculate lambda based on tenth best time: λ = ln(10) / ratio(tenth)
