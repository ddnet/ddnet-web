(function(G)
	{
	 var B,J,C,K,N,M,I,E,H,A,L;J=!!document.createElement("canvas").getContext;
	 B=(function()
		{
	 ...
	 if(J)
		{
		 ...
		 C=function(O)
			{
			 var P=G('<canvas style="width:'+(O.width+4 /* canvas css margin * -2 */)+"px;height:"+(O.height+4 /* canvas css margin * -2 */)+'px;"></canvas>').get(0);P.getContext("2d").clearRect(0,0,P.width,P.height);
			 return P
			};
		 ...
		 return this.each(function()
			{
			 ...
			 T=C(this);
			 G(T).css(I);
			 T.height=this.height+4; // canvas css margin * -2
			 T.width=this.width+4; // canvas css margin * -2
			 X=function(c)
				{
				 var a,b;
				 b=L(this,Y);
